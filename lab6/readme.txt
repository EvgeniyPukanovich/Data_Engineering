...
Кроме этого, необходимо найти самостоятельно набор данных, размер которого будет составлять минимум 250 МБ. Выполнить вышеуказанные шаги и для этого набора данных.
